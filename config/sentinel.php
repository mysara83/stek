...
return [
    ...
    */
    ...
    'routing' => [
        'session_store'                => ['route' => 'utama'],
        'session_destroy'              => ['action' => '\\Sentinel\Controllers\SessionController@create'],
        'registration_complete'        => ['route' => 'utama'],
        'registration_activated'       => ['route' => 'utama'],
        'registration_resend'          => ['route' => 'utama'],
        'registration_reset_triggered' => ['route' => 'utama'],
        'registration_reset_invalid'   => ['route' => 'utama'],
        'registration_reset_complete'  => ['route' => 'utama'],
        'users_invalid'                => ['route' => 'utama'],
    ...
    */
    ...
    'redirect_if_authenticated' => 'utama',
